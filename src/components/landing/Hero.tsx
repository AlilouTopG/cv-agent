      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 pb-20 pt-16 lg:grid-cols-2 lg:pt-24">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-slate-600">
            No more blank pages or confusing templates. Answer a few simple
            questions and watch your ATS-friendly CV build itself in real time —
            then download a polished PDF in one click.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-slate-500">
            {["100% free", "No sign-up needed", "ATS-friendly output"].map(
              (item) => (
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
            ...
            <div className="space-y-3 px-4 py-5">
              <div className="flex items-start gap-2.5">
                ...
                <div className="rounded-2xl rounded-tl-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="rounded-2xl rounded-tl-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700">
                  Perfect — watch your CV preview update live. ✓
                </div>
              </div>
            </div>

            <div className="border-t border-slate-100 px-4 py-4">
              <div className="mx-auto flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
