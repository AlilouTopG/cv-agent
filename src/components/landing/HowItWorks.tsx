...
export default function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="bg-gradient-to-b from-slate-50 to-white py-20 dark:from-zinc-900 dark:to-zinc-950"
    >
      <div className="mx-auto max-w-7xl px-5">
        ...
        <div className="relative mt-14 grid gap-10 lg:grid-cols-3">
          <div className="pointer-events-none absolute left-[16%] right-[16%] top-8 hidden border-t-2 border-dashed border-slate-200 lg:block dark:border-zinc-800" />
          {steps.map((step) => (
            <div key={step.step} className="relative text-center">
              <div className="relative mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#2563eb] to-[#7c3aed] text-white shadow-lg shadow-[#7c3aed]/20">
                ...
                <span className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-slate-900 text-[11px] font-bold text-white dark:bg-zinc-950">
                  {step.step.slice(1)}
                </span>
              </div>
